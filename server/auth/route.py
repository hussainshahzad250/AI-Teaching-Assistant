...
from .model import StudentUser, TeacherUser, ResetPasswordRequest
...
def reset_password(req: ResetPasswordRequest):
    """Resets password after verifying username and email match"""
    user = users_collection.find_one({"username": req.username, "email": req.email})
    if not user:
